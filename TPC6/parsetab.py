...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','tpc6.py',37),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','tpc6.py',41),
  ('expression -> term','expression',1,'p_expression_term','tpc6.py',45),
  ('term -> term TIMES factor','term',3,'p_term_times','tpc6.py',49),
  ('term -> term DIVIDE factor','term',3,'p_term_div','tpc6.py',53),
  ('term -> factor','term',1,'p_term_factor','tpc6.py',62),
  ('factor -> NUMBER','factor',1,'p_factor_num','tpc6.py',66),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','tpc6.py',70),
]
